...
Input snapshots come from a provider (`fixture` by default, optional `free` Yahoo prices and annual fundamentals, optional `jquants` FY summaries, or optional `edinet` yuho XBRL). See `docs/providers.md`. The formulas below do not change by source.
