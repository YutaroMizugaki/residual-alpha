...
Input snapshots come from a provider (`fixture` by default, optional `free` Yahoo prices and annual fundamentals, or optional `jquants` FY summaries). See `docs/providers.md`. The formulas below do not change by source.
